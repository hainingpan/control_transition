...
def run_tensor(inputs):
    ...
    torch.cuda.empty_cache()
    peak_memory_MB = torch.cuda.max_memory_allocated()/ (1024 ** 2)
    return peak_memory_MB, tensor_size
    # return log_q,log_r,log_r_

# inputs=(10,0,0.1,100,2000,0,0)
inputs=(12,0,0,1024,100,0,0)

print('Peak GPU RAM:{:.2f} MB\nTensor GPU Ram:{:.2f} MB'.format(*run_tensor(inputs)))