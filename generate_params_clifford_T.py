...
p_m_values = np.array([0.5 , 0.55, 0.6 , 0.64, 0.65, 0.66, .662, .664, .666, 0.668,0.67,0.672, 0.674,0.676, 0.678, 0.68, 0.69, 0.7 , 0.71,0.72, 0.73, 0.74, 0.75])  
...
# This is for t = 256**1.62 for L = [16, 32,64,128]
# batch_config = {
#     # L=16: max es*es_C = 864000/0.225 = 3.84M, use 500*500=250k (1 job per p_m)
...
# This is for t = 256**1.62 for L = [16, 32,64,] and t = 6*L**1.62 for L=128, t = L**1.62 for L=256
batch_config = {
    # L=16: max es*es_C = 864000/0.225 = 3.84M, use 500*500=250k (1 job per p_m)
    # 16: {'total_es': 500, 'total_es_C': 500, 'es_batch': 500, 'es_C_batch': 50},
