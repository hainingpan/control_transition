...
PARAMS_FILE="$PWD/params_1_3_anc_T.txt"
...
# for run_pytorch.py
srun singularity exec --nv /scratch/hp636/pytorch.sif python run_pytorch_T.py -seed $seed -p_ctrl $p_ctrl $p_ctrl 1 -p_proj $p_proj $p_proj 1 -L $L1 $L2 2 -xj "$xj" -es $es $ancilla
